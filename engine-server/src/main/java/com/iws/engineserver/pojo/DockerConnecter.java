...
public class DockerConnecter {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        DockerConnecter dockerConnecter = new DockerConnecter("tcp://10.16.156.137:2375","admin","123456","10.16.97.52:8433");
...
//        DockerConnecter dockerConnecter = new DockerConnecter("tcp://10.16.11.109:2375","admin","123456","10.16.97.52:8433");
...
//                .withDockerHost("tcp://10.16.97.52:2375")
...
//                .withRegistryUrl("https://index.docker.io/v1/")
////                .withRegistryUrl("http://10.16.97.52:8433")
//                .build();
//
//        DockerHttpClient httpClient = new ApacheDockerHttpClient.Builder()
//                .dockerHost(config.getDockerHost())
...
//        String newImg="10.16.97.52:8433/library/hello-world:latest";
//
//
...
//                .withUsername("admin")
//                .withPassword("123456")
//                .withRegistryAddress("http://10.16.97.52:8433");
//
//
//        dockerConnecter.getClient().tagImageCmd(Img,newImg,newImg.split(":")[1]).exec();
//
//        dockerConnecter.getClient().pushImageCmd("10.16.97.52:8433/library/hello-world:latest").withAuthConfig(authConfig).start().awaitCompletion();
