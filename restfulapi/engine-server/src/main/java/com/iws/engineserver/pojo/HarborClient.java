...
//                "http://10.16.17.92:8433/api/v2.0/projects/tmp/repositories/busybox/artifacts/2021.06.20-20.41.50",
                url,
                HttpMethod.DELETE,
                request,
                Map.class);
    ...
    public List<JSONObject> listImages(String project,int page, int page_size){
        ArrayList<JSONObject> images = new ArrayList<>();

        String url="http://"+address+"/api/v2.0/projects/"+project+"/repositories/"+"?page=1&page_size=10";
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        String imageName="10.16.17.92:8433/tmp/dev1:2021.06.23-01.43.50";

        HarborClient harborClient = new HarborClient("10.16.17.92:8433");
        VisualTool.showList(harborClient.listImages("public",1,100),new ArrayList<>(Arrays.asList("name","tag","imageID","created","size")));
    }
}
